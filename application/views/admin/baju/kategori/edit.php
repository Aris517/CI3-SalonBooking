        ...
        <div class="card-body">
            ...
            <div class="card">
                <div class="card-body p-4">
                    <form action="<?= base_url('baju/proses_edit_kategori/' . $kategori->id) ?>" method="post">
                        <div class="mb-3">
                            <label class="form-label">Kategori Baju</label>
                            <input type="text" class="form-control" name="kategori" value="<?= $kategori->kategori_baju ?>" required>
                        </div>
